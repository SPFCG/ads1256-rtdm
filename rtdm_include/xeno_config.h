...
/* config */
#define CONFIG_XENO_BUILD_ARGS " 'CFLAGS=-march=armv7-a  -mfloat-abi=hard -mfpu=neon -ffast-math' '--host=arm-linux-gnueabihf' '--enable-smp' '--with-core=cobalt' 'host_alias=arm-linux-gnueabihf'"
...
/* Compiler */
#define CONFIG_XENO_COMPILER "gcc version 6.3.0 20170406 (Ubuntu/Linaro 6.3.0-12ubuntu2) "
...
/* config */
#define CONFIG_XENO_VERSION_NAME "Washed Out Harlequin"

/* config */
#define CONFIG_XENO_VERSION_STRING "3.0.4"
...
#define PACKAGE_STRING "Xenomai 3.0.4"
